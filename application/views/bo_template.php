                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                <li class="nav-item dropdown me-3">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li><a href="<?php echo site_url(); ?>BackOffice/changeBoLanguage/French" class="dropdown-item">Français</a></li>
                                        <li><a href="<?php echo site_url(); ?>BackOffice/changeBoLanguage/English" class="dropdown-item">Anglais</a></li>
                                        <li><a href="<?php echo site_url(); ?>BackOffice/changeBoLanguage/Italian" class="dropdown-item">Italien</a></li>
                                        <li><a href="<?php echo site_url(); ?>BackOffice/changeBoLanguage/Spanish" class="dropdown-item">Espagnol</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <div class="dropdown">
